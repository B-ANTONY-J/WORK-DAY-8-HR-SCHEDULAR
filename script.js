$(document).ready(function () {
  ...
  for (let hour = 9; hour <= 17; hour++) {
    ...
    // add col width/row component 
    $rowDiv.append($col1SaveDiv);
    $col1SaveDiv.append($saveBtn);
    // STOP building save portion of row - here FINGERS CROSSED
  ...
  // saves to local storage as needed - CONSOLE LOG FREQUENTLY
